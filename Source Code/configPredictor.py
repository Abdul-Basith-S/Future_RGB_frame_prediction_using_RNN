...
def flying_objects_config():
  ...
  cfg.training_data_dir = "/data/tmp/data/FlyingObjectDataset_10K/training"
  cfg.validation_data_dir = "/data/tmp/data/FlyingObjectDataset_10K/validation"
  cfg.testing_data_dir = "/data/tmp/data/FlyingObjectDataset_10K/testing"
    
  cfg.GPU = 0                 # GPU ID
  cfg.DROPOUT_PROB = 0.3      # Probability to keep a node in dropout
